...
try:
    ...
    get_current_lane_projection = None
    get_left_lane_projection = None
    get_right_lane_projection = None
    select_agent_ind = None
    transform_coord_agents_to_world = None
    transform_coord_world_to_agent_i = None
