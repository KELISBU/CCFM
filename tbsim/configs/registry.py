...
EXP_CONFIG_REGISTRY["nusc_flowmatching"] = ExperimentConfig(
    train_config=NuscTrainConfig(),
    env_config=NuscEnvConfig(),
    algo_config=FlowmatchingTrafficConfig(),
    registered_name="nusc_flowmatching"    
)
...
EXP_CONFIG_REGISTRY["nusc_strive"] = ExperimentConfig(
    train_config=NuscTrainConfig(),
    env_config=NuscEnvConfig(),
    algo_config=STRIVEConfig(),
    registered_name="nusc_strive"
)
