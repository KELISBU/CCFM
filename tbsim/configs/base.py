...
class TrainConfig(Dict):
    def __init__(self):
        ...
        # trajdata dataset/cache controls
        self.load_cache = True
        self.data_filter = ""
        self.trajdata_cache_location = "~/.unified_data_cache"
        self.trajdata_cache_type = "dataframe"
        self.trajdata_rebuild_cache = False
        self.trajdata_rebuild_maps = False
        self.trajdata_save_index = False
        self.trajdata_data_dirs = {}
        # trajdata internal worker pool (separate from PyTorch DataLoader workers)
        self.trajdata_num_workers = 0
